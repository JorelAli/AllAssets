...
public class CommandDisguise {
			...
			switch (args.getArgs().length) {
				...
				case 1: {
					if (exists(args.getArgs()[0])) {
						final DisguiseLib d = new DisguiseLib(player, EntityDisguise.valueOf(args.getArgs()[0].toUpperCase()));
				...
				case 2: {
					if (exists(args.getArgs()[0])) {
						final DisguiseLib d = new DisguiseLib(player, EntityDisguise.valueOf(args.getArgs()[0].toUpperCase()), args.getArgs()[0]);
						d.setItemInHand(player.getItemInHand());
						d.setHelmet(player.getInventory().getHelmet());
						d.setChestplate(player.getInventory().getChestplate());
						d.setLeggings(player.getInventory().getLeggings());
	...
	private boolean exists(final String mob) {
