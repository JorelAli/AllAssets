...
/**
 * List of all MySQL datatypes.
 * Descriptions taken from <a href="http://dev.mysql.com/doc/refman/5.0/en/data-type-overview.html">MySQL Docs</a>.
 */
public class DataType {
     ...
     * Display width is unrelated to the range of values a type can contain, as described in <a href="http://dev.mysql.com/doc/refman/5.0/en/numeric-types.html">Section 11.1.4, "Numeric Types"</a>.
    ...
    public enum Numeric {
         ...
         * You may also use {@code TRUE} or {@code FALSE}.
         */
        BOOLEAN,
         ...
         * The maximum number of digits (M) for DECIMAL is 65 (64 from 5.0.3 to 5.0.5). The maximum number of supported decimals (D) is 30. If D is omitted, the default is 0.
        ...
        /**
         * Returns the string representation of this {@link Numeric} {@link DataType}
         ...
         */
        public java.lang.String toString(boolean zerofill, boolean unsigned, Object... arguments) {
    ...
    /**
     * <b>Temporal Data Types</b> <p>
     * For the {@link Temporal#DATE} and {@link Temporal#DATETIME} range descriptions, “supported” means that although earlier values might work, there is no guarantee.
     */
    public enum Temporal {
         ...
         * MySQL displays TIME values in 'HH:MM:SS' format, but permits assignment of values to TIME columns using either strings or numbers.
         */
        TIME,
         ...
         * YEAR(2) or YEAR(4) differ in display format, but have the same range of values.
         ...
         * MySQL displays YEAR values in YYYY or YYformat, but permits assignment of values to YEAR columns using either strings or numbers.
         */
        YEAR;

        /**
         * Returns the string representation of this {@link Temporal} {@link DataType}
         ...
         * @return the string representation of this temporal data type
         */
        public java.lang.String toString(Object... arguments) {
            StringBuilder builder = new StringBuilder(this.name());
    ...
    public enum String {
         ...
         * For example, utf8 characters can require up to three bytes per character, so a VARCHAR column that uses the utf8 character set can be declared to be a maximum of 21,844 characters.
         */
        VARCHAR,
         ...
         * An optional length M can be given for this type.
         * If this is done, MySQL creates the column as the smallest TEXT type large enough to hold values M characters long.
         */
        TEXT,
         ...
         * For more information on this limit, see Section E.7.5, “Limits Imposed by .frm File Structure”.
         */
        SET;

        /**
         * Returns the string representation of this {@link String} {@link DataType}
         * @param national indicates if this column should use some predefined character set
         ...
         */
        public java.lang.String toString(boolean national, java.lang.String charset, java.lang.String collate, Object... arguments) {
